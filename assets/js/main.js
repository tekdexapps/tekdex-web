...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        //>> Nice Select Start <<//
        // The plugin was dropped with the language switcher (nothing on the site
        // uses a <select> any more). Calling it unguarded threw and aborted the
        // rest of this file — which is where every Swiper is initialised.
